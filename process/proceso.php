    ...
    function setColFamiliares(){
        ...
        try {
            ...
            while ($rowMSSQL = $stmtMSSQL->fetch()) {
                ...
                if (isset($rowMSSQL['familiar_celular_prefijo']) && trim($rowMSSQL['familiar_celular_prefijo']) != '' && $rowMSSQL['familiar_celular_prefijo'] != NULL && $rowMSSQL['familiar_celular_prefijo'] != '021' && $rowMSSQL['familiar_celular_prefijo'] != '014'){
