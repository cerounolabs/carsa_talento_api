<?php
    ...
    $app->post('/v1/login/ip', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->post('/v1/100/migracion', function($request) {
        ...
        $sql02      = "INSERT INTO sistema.FUNFIC (FUNFICEST, FUNFICTDC, FUNFICTSC, FUNFICECC, FUNFICNAC, FUNFICCFU, FUNFICNO1, FUNFICNO2, FUNFICAP1, FUNFICAP2, FUNFICAP3, FUNFICDNU, FUNFICDVE, FUNFICFNA, FUNFICEMA, FUNFICFOT, FUNFICOBS, FUNFICAUS, FUNFICAFH, FUNFICAIP) VALUES ((SELECT DOMFICCOD FROM sistema.DOMFIC WHERE DOMFICVAL = 'COLABORADORESTADO' AND DOMFICEQU = ?), (SELECT DOMFICCOD FROM sistema.DOMFIC WHERE DOMFICVAL = 'PERSONADOCUMENTO' AND DOMFICEQU = ?), (SELECT DOMFICCOD FROM sistema.DOMFIC WHERE DOMFICVAL = 'PERSONASEXO' AND DOMFICEQU = ?), (SELECT DOMFICCOD FROM sistema.DOMFIC WHERE DOMFICVAL = 'PERSONAESTADOCIVIL' AND DOMFICEQU = ?), (SELECT LOCPAICOD FROM sistema.LOCPAI WHERE LOCPAICO1 = ?), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), ?)";
    ...
    $app->post('/v1/400/sistema', function($request) {
        require __DIR__.'/../src/connect.php';
        ...
        if (isset($val01) && isset($val02) && isset($val03)) {
            $sql00  = "INSERT INTO sistema.LOGFIC (LOGFICEST, LOGFICTCC, LOGFICNOM, LOGFICURL, LOGFICOBS, LOGFICAUS, LOGFICAFH, LOGFICAIP) VALUES (?, ?, ?, ?, ?, ?, NOW(), ?)";
