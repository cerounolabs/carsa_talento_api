...
CREATE TABLE `FUNFICA` (
    ...
    `FUNFICAECCOLD` mediumint(9) NOT NULL COMMENT 'ESTADO CIVIL OLD',
    ...
    `FUNFICAECCNEW` mediumint(9) NOT NULL COMMENT 'ESTADO CIVIL NEW',
...
CREATE TRIGGER `FUNFICDLT` BEFORE DELETE ON `FUNFIC`
    FOR EACH ROW 
        INSERT INTO `FUNFICA` (`FUNFICAMET`, `FUNFICAUSU`, `FUNFICAFEC`, `FUNFICADIP`, `FUNFICACODOLD`, `FUNFICAESTOLD`, `FUNFICATDCOLD`, `FUNFICATSCOLD`, `FUNFICAECCOLD`, `FUNFICACFUOLD`, `FUNFICANOMOLD`, `FUNFICAAPEOLD`, `FUNFICADOCOLD`, `FUNFICAFHAOLD`, `FUNFICAOBSOLD`) 
        VALUES ('DELETE', OLD.`FUNFICAUS`, OLD.`FUNFICAFH`, OLD.`FUNFICAIP`, OLD.`FUNFICCOD`, OLD.`FUNFICEST`, OLD.`FUNFICTDC`, OLD.`FUNFICTSC`, OLD.`FUNFICECC`, OLD.`FUNFICCFU`, OLD.`FUNFICNOM`, OLD.`FUNFICAPE`, OLD.`FUNFICDOC`, OLD.`FUNFICFHA`, OLD.`FUNFICOBS`);

CREATE TRIGGER `FUNFICINS` AFTER INSERT ON `FUNFIC`
    FOR EACH ROW 
        INSERT INTO `FUNFICA` (`FUNFICAMET`, `FUNFICAUSU`, `FUNFICAFEC`, `FUNFICADIP`, `FUNFICACODNEW`, `FUNFICAESTNEW`, `FUNFICATDCNEW`, `FUNFICATSCNEW`, `FUNFICAECCNEW`, `FUNFICACFUNEW`, `FUNFICANOMNEW`, `FUNFICAAPENEW`, `FUNFICADOCNEW`, `FUNFICAFHANEW`, `FUNFICAOBSNEW`) 
        VALUES ('INSERT', NEW.`FUNFICAUS`, NEW.`FUNFICAFH`, NEW.`FUNFICAIP`, NEW.`FUNFICCOD`, NEW.`FUNFICEST`, NEW.`FUNFICTDC`, NEW.`FUNFICTSC`, NEW.`FUNFICECC`, NEW.`FUNFICCFU`, NEW.`FUNFICNOM`, NEW.`FUNFICAPE`, NEW.`FUNFICDOC`, NEW.`FUNFICFHA`, NEW.`FUNFICOBS`);

CREATE TRIGGER `FUNFICUPD` AFTER UPDATE ON `FUNFIC`
    FOR EACH ROW 
        INSERT INTO `FUNFICA` (`FUNFICAMET`, `FUNFICAUSU`, `FUNFICAFEC`, `FUNFICADIP`, `FUNFICACODOLD`, `FUNFICAESTOLD`, `FUNFICATDCOLD`, `FUNFICATSCOLD`, `FUNFICAECCOLD`, `FUNFICACFUOLD`, `FUNFICANOMOLD`, `FUNFICAAPEOLD`, `FUNFICADOCOLD`, `FUNFICAFHAOLD`, `FUNFICAOBSOLD`, `FUNFICACODNEW`, `FUNFICAESTNEW`, `FUNFICATDCNEW`, `FUNFICATSCNEW`, `FUNFICAECCNEW`, `FUNFICACFUNEW`, `FUNFICANOMNEW`, `FUNFICAAPENEW`, `FUNFICADOCNEW`, `FUNFICAFHANEW`, `FUNFICAOBSNEW`) 
        VALUES ('UPDATE', NEW.`FUNFICAUS`, NEW.`FUNFICAFH`, NEW.`FUNFICAIP`, OLD.`FUNFICCOD`, OLD.`FUNFICEST`, OLD.`FUNFICTDC`, OLD.`FUNFICTSC`, OLD.`FUNFICECC`, OLD.`FUNFICCFU`, OLD.`FUNFICNOM`, OLD.`FUNFICAPE`, OLD.`FUNFICDOC`, OLD.`FUNFICFHA`, OLD.`FUNFICOBS`, NEW.`FUNFICCOD`, NEW.`FUNFICEST`, NEW.`FUNFICTDC`, NEW.`FUNFICTSC`, NEW.`FUNFICECC`, NEW.`FUNFICCFU`, NEW.`FUNFICNOM`, NEW.`FUNFICAPE`, NEW.`FUNFICDOC`, NEW.`FUNFICFHA`, NEW.`FUNFICOBS`);
