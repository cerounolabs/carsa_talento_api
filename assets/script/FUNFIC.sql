...
CREATE TRIGGER `FUNFICDLT` BEFORE DELETE ON `FUNFIC`
    FOR EACH ROW 
        INSERT INTO `FUNFICA` (`FUNFICAMET`, `FUNFICAUSU`, `FUNFICAFEC`, `FUNFICADIP`, `FUNFICACODOLD`, `FUNFICAESTOLD`, `FUNFICATDCOLD`, `FUNFICATSCOLD`, `FUNFICAECCOLD`, `FUNFICACFUOLD`, `FUNFICANOMOLD`, `FUNFICAAPEOLD`, `FUNFICADOCOLD`, `FUNFICAFHAOLD`, `FUNFICAEMAOLD`, `FUNFICAFOTOLD`, `FUNFICAOBSOLD`) 
        VALUES ('DELETE', OLD.`FUNFICAUS`, NOW(), OLD.`FUNFICAIP`, OLD.`FUNFICCOD`, OLD.`FUNFICEST`, OLD.`FUNFICTDC`, OLD.`FUNFICTSC`, OLD.`FUNFICECC`, OLD.`FUNFICCFU`, OLD.`FUNFICNOM`, OLD.`FUNFICAPE`, OLD.`FUNFICDOC`, OLD.`FUNFICFHA`, OLD.`FUNFICEMA`, OLD.`FUNFICFOT`, OLD.`FUNFICOBS`);

CREATE TRIGGER `FUNFICINS` AFTER INSERT ON `FUNFIC`
    FOR EACH ROW 
        INSERT INTO `FUNFICA` (`FUNFICAMET`, `FUNFICAUSU`, `FUNFICAFEC`, `FUNFICADIP`, `FUNFICACODNEW`, `FUNFICAESTNEW`, `FUNFICATDCNEW`, `FUNFICATSCNEW`, `FUNFICAECCNEW`, `FUNFICACFUNEW`, `FUNFICANOMNEW`, `FUNFICAAPENEW`, `FUNFICADOCNEW`, `FUNFICAFHANEW`, `FUNFICAEMANEW`, `FUNFICAFOTNEW`, `FUNFICAOBSNEW`) 
        VALUES ('INSERT', NEW.`FUNFICAUS`, NOW(), NEW.`FUNFICAIP`, NEW.`FUNFICCOD`, NEW.`FUNFICEST`, NEW.`FUNFICTDC`, NEW.`FUNFICTSC`, NEW.`FUNFICECC`, NEW.`FUNFICCFU`, NEW.`FUNFICNOM`, NEW.`FUNFICAPE`, NEW.`FUNFICDOC`, NEW.`FUNFICFHA`, NEW.`FUNFICEMA`, NEW.`FUNFICFOT`,  NEW.`FUNFICOBS`);

CREATE TRIGGER `FUNFICUPD` AFTER UPDATE ON `FUNFIC`
    FOR EACH ROW 
        INSERT INTO `FUNFICA` (`FUNFICAMET`, `FUNFICAUSU`, `FUNFICAFEC`, `FUNFICADIP`, `FUNFICACODOLD`, `FUNFICAESTOLD`, `FUNFICATDCOLD`, `FUNFICATSCOLD`, `FUNFICAECCOLD`, `FUNFICACFUOLD`, `FUNFICANOMOLD`, `FUNFICAAPEOLD`, `FUNFICADOCOLD`, `FUNFICAFHAOLD`, `FUNFICAEMAOLD`, `FUNFICAFOTOLD`, `FUNFICAOBSOLD`, `FUNFICACODNEW`, `FUNFICAESTNEW`, `FUNFICATDCNEW`, `FUNFICATSCNEW`, `FUNFICAECCNEW`, `FUNFICACFUNEW`, `FUNFICANOMNEW`, `FUNFICAAPENEW`, `FUNFICADOCNEW`, `FUNFICAFHANEW`, `FUNFICAEMANEW`, `FUNFICAOBSNEW`) 
        VALUES ('UPDATE', NEW.`FUNFICAUS`, NOW(), NEW.`FUNFICAIP`, OLD.`FUNFICCOD`, OLD.`FUNFICEST`, OLD.`FUNFICTDC`, OLD.`FUNFICTSC`, OLD.`FUNFICECC`, OLD.`FUNFICCFU`, OLD.`FUNFICNOM`, OLD.`FUNFICAPE`, OLD.`FUNFICDOC`, OLD.`FUNFICFHA`, OLD.`FUNFICEMA`, OLD.`FUNFICFOT`, OLD.`FUNFICOBS`, NEW.`FUNFICCOD`, NEW.`FUNFICEST`, NEW.`FUNFICTDC`, NEW.`FUNFICTSC`, NEW.`FUNFICECC`, NEW.`FUNFICCFU`, NEW.`FUNFICNOM`, NEW.`FUNFICAPE`, NEW.`FUNFICDOC`, NEW.`FUNFICFHA`, NEW.`FUNFICEMA`, NEW.`FUNFICFOT`, NEW.`FUNFICOBS`);
