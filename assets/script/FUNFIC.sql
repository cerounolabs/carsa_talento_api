CREATE TABLE IF NOT EXISTS `FUNFIC` (
    ...
    `FUNFICTNC` mediumint(9) NOT NULL COMMENT 'NACIONALIDAD',
    ...
    `FUNFICDOF` date NOT NULL COMMENT 'VENCIMIENTO DOCUMENTO',
    `FUNFICFHA` date NOT NULL COMMENT 'FECHA NACIMIENTO',
    `FUNFICEMA` varchar(100) COLLATE utf8_spanish_ci NULL COMMENT 'EMAIL',
    `FUNFICFOT` varchar(100) COLLATE utf8_spanish_ci NULL COMMENT 'FOTO',
...
CREATE TABLE IF NOT EXISTS `FUNFICA` (
    ...
    `FUNFICATNCOLD` mediumint(9) NULL COMMENT 'NACIONALIDAD OLD',
    ...
    `FUNFICADOFOLD` date NULL COMMENT 'VENCIMIENTO DOCUMENTO OLD',
    ...
    `FUNFICAFOTOLD` varchar(100) COLLATE utf8_spanish_ci NULL COMMENT 'FOTO OLD',
    ...
    `FUNFICATNCNEW` mediumint(9) NULL COMMENT 'NACIONALIDAD NEW',
    ...
    `FUNFICADOFNEW` date NULL COMMENT 'VENCIMIENTO DOCUMENTO NEW',
    ...
    `FUNFICAFOTNEW` varchar(100) COLLATE utf8_spanish_ci NULL COMMENT 'FOTO NEW',
...
CREATE TRIGGER `FUNFICDLT` BEFORE DELETE ON `FUNFIC`
    FOR EACH ROW 
        INSERT INTO `FUNFICA` (`FUNFICAMET`, `FUNFICAUSU`, `FUNFICAFEC`, `FUNFICADIP`, `FUNFICACODOLD`, `FUNFICAESTOLD`, `FUNFICATDCOLD`, `FUNFICATSCOLD`, `FUNFICAECCOLD`, `FUNFICATNCOLD`, `FUNFICACFUOLD`, `FUNFICANOMOLD`, `FUNFICAAPEOLD`, `FUNFICADOCOLD`, `FUNFICADOFOLD`, `FUNFICAFHAOLD`, `FUNFICAEMAOLD`, `FUNFICAFOTOLD`, `FUNFICAOBSOLD`) 
        VALUES ('DELETE', OLD.`FUNFICAUS`, NOW(), OLD.`FUNFICAIP`, OLD.`FUNFICCOD`, OLD.`FUNFICEST`, OLD.`FUNFICTDC`, OLD.`FUNFICTSC`, OLD.`FUNFICECC`, OLD.`FUNFICTNC`, OLD.`FUNFICCFU`, OLD.`FUNFICNOM`, OLD.`FUNFICAPE`, OLD.`FUNFICDOC`, OLD.`FUNFICDOF`, OLD.`FUNFICFHA`, OLD.`FUNFICEMA`, OLD.`FUNFICFOT`, OLD.`FUNFICOBS`);

CREATE TRIGGER `FUNFICINS` AFTER INSERT ON `FUNFIC`
    FOR EACH ROW 
        INSERT INTO `FUNFICA` (`FUNFICAMET`, `FUNFICAUSU`, `FUNFICAFEC`, `FUNFICADIP`, `FUNFICACODNEW`, `FUNFICAESTNEW`, `FUNFICATDCNEW`, `FUNFICATSCNEW`, `FUNFICAECCNEW`, `FUNFICATNCNEW`, `FUNFICACFUNEW`, `FUNFICANOMNEW`, `FUNFICAAPENEW`, `FUNFICADOCNEW`, `FUNFICADOFNEW`, `FUNFICAFHANEW`, `FUNFICAEMANEW`, `FUNFICAFOTNEW`, `FUNFICAOBSNEW`) 
        VALUES ('INSERT', NEW.`FUNFICAUS`, NOW(), NEW.`FUNFICAIP`, NEW.`FUNFICCOD`, NEW.`FUNFICEST`, NEW.`FUNFICTDC`, NEW.`FUNFICTSC`, NEW.`FUNFICECC`, NEW.`FUNFICTNC`, NEW.`FUNFICCFU`, NEW.`FUNFICNOM`, NEW.`FUNFICAPE`, NEW.`FUNFICDOC`, NEW.`FUNFICDOF`, NEW.`FUNFICFHA`, NEW.`FUNFICEMA`, NEW.`FUNFICFOT`,  NEW.`FUNFICOBS`);

CREATE TRIGGER `FUNFICUPD` AFTER UPDATE ON `FUNFIC`
    FOR EACH ROW 
        INSERT INTO `FUNFICA` (`FUNFICAMET`, `FUNFICAUSU`, `FUNFICAFEC`, `FUNFICADIP`, `FUNFICACODOLD`, `FUNFICAESTOLD`, `FUNFICATDCOLD`, `FUNFICATSCOLD`, `FUNFICAECCOLD`, `FUNFICATNCOLD`, `FUNFICACFUOLD`, `FUNFICANOMOLD`, `FUNFICAAPEOLD`, `FUNFICADOCOLD`, `FUNFICADOFOLD`, `FUNFICAFHAOLD`, `FUNFICAEMAOLD`, `FUNFICAFOTOLD`, `FUNFICAOBSOLD`, `FUNFICACODNEW`, `FUNFICAESTNEW`, `FUNFICATDCNEW`, `FUNFICATSCNEW`, `FUNFICAECCNEW`, `FUNFICATNCNEW`, `FUNFICACFUNEW`, `FUNFICANOMNEW`, `FUNFICAAPENEW`, `FUNFICADOCNEW`, `FUNFICADOFNEW`, `FUNFICAFHANEW`, `FUNFICAEMANEW`, `FUNFICAOBSNEW`) 
        VALUES ('UPDATE', NEW.`FUNFICAUS`, NOW(), NEW.`FUNFICAIP`, OLD.`FUNFICCOD`, OLD.`FUNFICEST`, OLD.`FUNFICTDC`, OLD.`FUNFICTSC`, OLD.`FUNFICECC`, OLD.`FUNFICTNC`, OLD.`FUNFICCFU`, OLD.`FUNFICNOM`, OLD.`FUNFICAPE`, OLD.`FUNFICDOC`, OLD.`FUNFICDOF`, OLD.`FUNFICFHA`, OLD.`FUNFICEMA`, OLD.`FUNFICFOT`, OLD.`FUNFICOBS`, NEW.`FUNFICCOD`, NEW.`FUNFICEST`, NEW.`FUNFICTDC`, NEW.`FUNFICTSC`, NEW.`FUNFICECC`, NEW.`FUNFICTNC`, NEW.`FUNFICCFU`, NEW.`FUNFICNOM`, NEW.`FUNFICAPE`, NEW.`FUNFICDOC`, NEW.`FUNFICDOF`, NEW.`FUNFICFHA`, NEW.`FUNFICEMA`, NEW.`FUNFICFOT`, NEW.`FUNFICOBS`);
...
ALTER TABLE `FUNFIC` ADD KEY `FUNFICTNC` (`FUNFICTNC`);
ALTER TABLE `FUNFIC` ADD CONSTRAINT `FK_FUNFIC_FUNFICTNC` FOREIGN KEY (`FUNFICTNC`) REFERENCES `DOMFIC` (`DOMFICCOD`) ON DELETE RESTRICT ON UPDATE RESTRICT;
