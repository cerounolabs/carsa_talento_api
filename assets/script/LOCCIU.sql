...
CREATE TABLE IF NOT EXISTS `LOCCIUA` (
    ...
    `LOCCIUACODOLD` mediumint(9) NOT NULL COMMENT 'CÓDIGO OLD',
    `LOCCIUAESTOLD` char(1) COLLATE utf8_spanish_ci NOT NULL COMMENT 'ESTADO OLD',
    `LOCCIUADECOLD` mediumint(9) NOT NULL COMMENT 'DEPARTAMENTO OLD',
    ...
    `LOCCIUACODNEW` mediumint(9) NOT NULL COMMENT 'CÓDIGO NEW',
    `LOCCIUAESTNEW` char(1) COLLATE utf8_spanish_ci NOT NULL COMMENT 'ESTADO NEW',
    `LOCCIUADECNEW` mediumint(9) NOT NULL COMMENT 'DEPARTAMENTO NEW',
