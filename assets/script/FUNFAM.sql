...
CREATE TABLE IF NOT EXISTS `FUNFAMA` (
    ...
    `FUNFAMANOMOLD` varchar(100) COLLATE utf8_spanish_ci NULL COMMENT 'PERSONA OLD',
    ...
    `FUNFAMACODNEW` mediumint(9) NULL COMMENT 'CÓDIGO',
    `FUNFAMAESTNEW` char(1) COLLATE utf8_spanish_ci NULL COMMENT 'ESTADO',
    `FUNFAMATPCNEW` mediumint(9) NULL COMMENT 'TIPO PARENTEZCO',
    `FUNFAMAFUCNEW` mediumint(9) NULL COMMENT 'FUNCIONARIO',
    `FUNFAMANOMNEW` varchar(100) COLLATE utf8_spanish_ci NULL COMMENT 'PERSONA',
