CREATE TABLE IF NOT EXISTS `LOCBAR` (
    ...
    `LOCBAREQU` mediumint(9) NULL COMMENT 'CÓDIGO EQUIVALENCIA',
...
CREATE TABLE IF NOT EXISTS `LOCBARA` (
    ...
    `LOCBARAEQUOLD` mediumint(9) NULL COMMENT 'CÓDIGO EQUIVALENCIA OLD',
    ...
    `LOCBARAEQUNEW` mediumint(9) NULL COMMENT 'CÓDIGO EQUIVALENCIA NEW',
