CREATE TABLE `DOMFIC` (
  ...
  `DOMFICEQU` smallint(6) NULL COMMENT 'CÓDIGO EQUIVALENTE',
...
CREATE TABLE `DOMFICA` (
  ...
  `DOMFICAMET` char(20) COLLATE utf8_spanish_ci NULL COMMENT 'MÉTODO',
  `DOMFICAUSU` char(20) COLLATE utf8_spanish_ci NULL COMMENT 'USUARIO',
  `DOMFICAFEC` datetime DEFAULT NULL COMMENT 'FECHA HORA',
  `DOMFICADIP` char(20) COLLATE utf8_spanish_ci NULL COMMENT 'IP',
  ...
  `DOMFICAEQUOLD` smallint(6) DEFAULT NULL COMMENT 'CÓDIGO EQUIVALENTE ANTERIOR',
  `DOMFICAEQUNEW` smallint(6) DEFAULT NULL COMMENT 'CÓDIGO EQUIVALENTE ACTUAL',
