...
CREATE OR REPLACE FUNCTION auditoria.LOGFUN_functions() RETURNS TRIGGER AS $LOGFUN_functions$
  ...
  BEGIN
    ...
    IF (TG_OP = 'INSERT') THEN
        INSERT INTO auditoria.LOGFUN(LOGFUNAME, LOGFUNAUS, LOGFUNAFH, LOGFUNAIP, LOGFUNCOD, LOGFUNEST, LOGFUNFUC, LOGFUNDIP, LOGFUNOBS)
        VALUES ('INSERT AFTER', NEW.LOGFUNAUS, NOW(), NEW.LOGFUNAIP, NEW.LOGFUNCOD, NEW.LOGFUNEST, NEW.LOGFUNFUC, NEW.LOGFUNDIP, NEW.LOGFUNOBS);
        RETURN NEW;
    
    ELSEIF (TG_OP = 'UPDATE') THEN
        INSERT INTO auditoria.LOGFUN(LOGFUNAME, LOGFUNAUS, LOGFUNAFH, LOGFUNAIP, LOGFUNCOD, LOGFUNEST, LOGFUNFUC, LOGFUNDIP, LOGFUNOBS) VALUES 
        ('UPDATE BEFORE', OLD.LOGFUNAUS, NOW(), OLD.LOGFUNAIP, OLD.LOGFUNCOD, OLD.LOGFUNEST, OLD.LOGFUNFUC, OLD.LOGFUNDIP, OLD.LOGFUNOBS),
        ('UPDATE AFTER', NEW.LOGFUNAUS, NOW(), NEW.LOGFUNAIP, NEW.LOGFUNCOD, NEW.LOGFUNEST, NEW.LOGFUNFUC, NEW.LOGFUNDIP, NEW.LOGFUNOBS);
        RETURN NEW;

    ELSEIF (TG_OP = 'DELETE') THEN
        INSERT INTO auditoria.LOGFUN(LOGFUNAME, LOGFUNAUS, LOGFUNAFH, LOGFUNAIP, LOGFUNCOD, LOGFUNEST, LOGFUNFUC, LOGFUNDIP, LOGFUNOBS)
        VALUES ('DELETE BEFORE', OLD.LOGFUNAUS, NOW(), OLD.LOGFUNAIP, OLD.LOGFUNCOD, OLD.LOGFUNEST, OLD.LOGFUNFUC, OLD.LOGFUNDIP, OLD.LOGFUNOBS);
        RETURN NEW;
