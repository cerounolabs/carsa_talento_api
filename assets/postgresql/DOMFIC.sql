...
CREATE OR REPLACE FUNCTION auditoria.DOMFIC_functions() RETURNS TRIGGER AS $DOMFIC_functions$
  ...
  BEGIN
    ...
    ELSEIF (TG_OP = 'UPDATE') THEN
        INSERT INTO auditoria.DOMFIC(DOMFICAME, DOMFICAUS, DOMFICAFH, DOMFICAIP, DOMFICCOD, DOMFICEST, DOMFICNOM, DOMFICEQU, DOMFICVAL, DOMFICOBS) VALUES
        ('UPDATE BEFORE', OLD.DOMFICAUS, NOW(), OLD.DOMFICAIP, OLD.DOMFICCOD, OLD.DOMFICEST, OLD.DOMFICNOM, OLD.DOMFICEQU, OLD.DOMFICVAL, OLD.DOMFICOBS),
        ('UPDATE AFTER',  NEW.DOMFICAUS, NOW(), NEW.DOMFICAIP, NEW.DOMFICCOD, NEW.DOMFICEST, NEW.DOMFICNOM, NEW.DOMFICEQU, NEW.DOMFICVAL, NEW.DOMFICOBS);
        RETURN NEW;
