...
CREATE OR REPLACE FUNCTION auditoria.LOCPAI_functions() RETURNS TRIGGER AS $LOCPAI_functions$
  ...
  BEGIN
    ...
    ELSEIF (TG_OP = 'UPDATE') THEN
        INSERT INTO auditoria.LOCPAI(LOCPAIAME, LOCPAIAUS, LOCPAIAFH, LOCPAIAIP, LOCPAICOD, LOCPAIEST, LOCPAICO1, LOCPAINOM, LOCPAIBCP, LOCPAIGEN, LOCPAIOBS) VALUES
        ('UPDATE BEFORE', OLD.LOCPAIAUS, NOW(), OLD.LOCPAIAIP, OLD.LOCPAICOD, OLD.LOCPAIEST, OLD.LOCPAICO1, OLD.LOCPAINOM, OLD.LOCPAIBCP, OLD.LOCPAIGEN, OLD.LOCPAIOBS),
        ('UPDATE AFTER', NEW.LOCPAIAUS, NOW(), NEW.LOCPAIAIP, NEW.LOCPAICOD, NEW.LOCPAIEST, NEW.LOCPAICO1, NEW.LOCPAINOM, NEW.LOCPAIBCP, NEW.LOCPAIGEN, NEW.LOCPAIOBS);
        RETURN NEW;
