...
CREATE OR REPLACE FUNCTION auditoria.LOGFIC_functions() RETURNS TRIGGER AS $LOGFIC_functions$
  ...
  BEGIN
    ...
    ELSEIF (TG_OP = 'UPDATE') THEN
        INSERT INTO auditoria.LOGFIC(LOGFICAME, LOGFICAUS, LOGFICAFH, LOGFICAIP, LOGFICCOD, LOGFICEST, LOGFICTAC, LOGFICNOM, LOGFICOBS)
        VALUES ('UPDATE BEFORE', OLD.LOGFICAUS, NOW(), OLD.LOGFICAIP, OLD.LOGFICCOD, OLD.LOGFICEST, OLD.LOGFICTAC, OLD.LOGFICNOM, OLD.LOGFICOBS);

        INSERT INTO auditoria.LOGFIC(LOGFICAME, LOGFICAUS, LOGFICAFH, LOGFICAIP, LOGFICCOD, LOGFICEST, LOGFICTAC, LOGFICNOM, LOGFICOBS)
        VALUES ('UPDATE AFTER', NEW.LOGFICAUS, NOW(), NEW.LOGFICAIP, NEW.LOGFICCOD, NEW.LOGFICEST, NEW.LOGFICTAC, NEW.LOGFICNOM, NEW.LOGFICOBS);
        RETURN NULL;
